...
// @peculiar/webcrypto has Buffer (node api) on static
// which will be evaluated on import.
// That causes error on cloudflare worker
...
if ((typeof self !== "undefined") && "crypto" in self) {
	...
	throw new Error("This branch is not for your situation.")
